...
const (
	...
	TimeInForceType_TIME_IN_FORCE_FILL_OR_KILL  TimeInForceType = 3 //Заявка исполнена полностью или уничтожена, недоступно для срочного рынка и торговли по выходным
)
